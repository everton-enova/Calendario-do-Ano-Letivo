...
1. A URL do Web App já está gravada em `APPS_SCRIPT_URL` (linha 177 do `index.html`). Só precisa trocar se o Apps Script for reimplantado como **nova** implantação — editar uma implantação existente mantém a mesma URL.
